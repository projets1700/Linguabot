...
/**
 * The other 7 worlds from LinguaBot_V2_Conception.md §5 - no backend rows
 * exist for these yet (V2 pilot scope is Monde 1 only), so they're rendered
 * here as static "coming soon" cards rather than empty/inactive API data.
 */
