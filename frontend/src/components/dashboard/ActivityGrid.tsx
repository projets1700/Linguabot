...
type Props = {
  /** The A0 quiz has nothing left to offer past A0 (QuizController::modules() enforces this server-side too) - hidden entirely rather than shown locked, since there's no "unlock later" story for content the learner has already moved past. */
  isA0: boolean;
};

export function ActivityGrid({ isA0 }: Props) {
  return (
    <>
